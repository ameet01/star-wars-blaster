...
var Game = function () {
  function Game() {
    ...
    this.shipSelect = 1;
    this.waves = [_waves.waveOne, _waves.waveTwo, _waves.waveThree, _waves.waveFour, _waves.Boss];
    this.waveNum = 0;
    this.progress = false;
  }
  ...
  _createClass(Game, [{
    ...
    value: function initializeTicker() {
      ...
      this.ticker.addEventListener('tick', function () {
        if (!_this2.paused && _this2.gameStarted) {
          console.log(_this2.enemies);
          if (_this2.enemies.length === 0 && _this2.progress === true && _this2.waveNum < 4) {
            _this2.waveNum += 1;
            _this2.waves[_this2.waveNum](_this2);
    ...
    key: 'updateBossHealthBar',
    value: function updateBossHealthBar() {
      console.log(this.boss.health, this.boss.maxHealth, this.bosshealthbarWidth);
      var healthbar = $('#bosshealthbar-inside');
      var health = this.boss.health / this.boss.maxHealth;
      healthbar.css('width', this.bosshealthbarWidth * health + 'px');
    }
  }, {
    key: 'updateHealthBar',
    value: function updateHealthBar() {
      var health = this.lightsaberHeight * (this.ship.health / this.ship.maxHealth);
...
var DeathStar = exports.DeathStar = function (_Enemy2) {
  ...
  function DeathStar(velocityX, velocityY, game, typeofmove) {
    ...
    _this5.damage = 1;
    _this5.health = 375;
    _this5.maxHealth = _this5.health;
    _this5.enemy = new createjs.Bitmap('images/deathstar.png');
    _this5.enemy.scaleX = window.innerWidth / 1000 * 0.08;
    _this5.enemy.scaleY = window.innerWidth / 1000 * 0.08;
    _this5.tweening = false;
    _this5.shooting = false;
    _this5.typeofmove = typeofmove;
    _this5.hasSpiral = false;
    _this5.game.boss = _this5;
    return _this5;
  }
    ...
    value: function movedown(y) {
      ...
      if (this.tweening === false) {
        ...
        createjs.Tween.get(this.enemy, { useTicks: true, override: true }).wait(5).to({ y: y }, 60, createjs.Ease.backOut).call(function () {
          ...
          if (_this6.game.gameStarted && _this6.boss) {
            _this6.spiralAttack();
          }
