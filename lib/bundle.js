  ...
  _createClass(Game, [{
    ...
    value: function moveAllBullets() {
      ...
      this.bullets.forEach(function (bullet, index1) {
        bullet.move();
        _this3.enemies.forEach(function (enemy, index2) {
          if (bullet.hitEnemy(enemy)) {
            _this3.bullets.splice(index1, 1);
            if (enemy.health <= 0) {
              _this3.enemies.splice(index2, 1);
            }
          }
        });
      });
...
exports.PlayerBullet = exports.Bullet = undefined;
...
var MovingObject = function () {
  ...
  _createClass(MovingObject, [{
    ...
    value: function hitEnemy(enemy) {
      ...
      if (x < enemy.enemy.image.width && y < enemy.enemy.image.height) {
        this.game.stage.removeChild(this.bullet);
        enemy.health -= this.damage;
        if (enemy.health <= 0) {
          (0, _explosion2.default)(this.bullet.x, this.bullet.y, this.game.stage);
